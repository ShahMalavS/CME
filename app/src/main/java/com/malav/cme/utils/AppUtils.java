...
import com.malav.moodapp.R;
import com.malav.moodapp.beans.Mood;
...
public class AppUtils {
	...
	public static String prepareMoodHeadingStatement(String selectedMood){
		String message = "";
		switch(selectedMood){

			case "Angry":
				message = "You are " + selectedMood + " because..";
				break;
			case "Happy":
				message = "You are " + selectedMood + " when.. ";
				break;
			case "Irritated":
				message = "You are " + selectedMood + " because.. ";
				break;
			case "Excited":
				...
				break;
			case "Embarrassed":
				message = "You are feeling " + selectedMood + " because.. ";
				break;
			case "Curious":
				message = "You are " + selectedMood + " because..";
				break;
			case "Worried":
				...
				break;
			case "Love":
                message = "You have feel of " + selectedMood + " because.. ";
				break;
			case "Frustrated":
				message = "You are " + selectedMood + " because.. ";
				break;
			case "Thoughtful":
                message = "You are being " + selectedMood + " because..";
				break;
			case "Bored":
				message = "You are feeling " + selectedMood + " because..";
				break;
			case "Satisfied":
				message = "You are " + selectedMood + " with.. ";
				break;
			case "Guilt":
                message = "You are feeling " + selectedMood + " because.. ";
				break;
			...
			case "Restless":
				...
				break;
			case "Motivated":
                message = "You are " + selectedMood + " by.. ";
				break;
			case "Tension":
                message = "You are in " + selectedMood + " because.. ";
				break;
			case "Relaxed":
				message = "You are " + selectedMood + " because.. ";
				break;
			...
			case "Lazy":
				...
				break;
			case "Confident":
                message = "You are Confident because.. ";
				break;
		}
		return message;
	}

	public static int prepareMoodHeadingImage(String selectedMood){
		...
		switch(selectedMood){
			...
			case "Happy":
				...
				break;
			case "Irritated":
				image = R.drawable.irritated;
				break;
			case "Excited":
				image = R.drawable.excited;
				break;
			case "Embarrassed":
				image = R.drawable.embarrassed;
				break;
			case "Curious":
				image = R.drawable.curious;
				break;
			case "Worried":
				image = R.drawable.worried;
				break;
			case "Love":
			...
			case "Frustrated":
				...
				break;
			case "Thoughtful":
				image = R.drawable.thoughtful;
				break;
			case "Bored":
				image = R.drawable.bored;
				break;
			case "Satisfied":
				image = R.drawable.satisfied;
				break;
			case "Guilt":
				image = R.drawable.guilt;
				break;
			case "Imaginative":
				image = R.drawable.imaginative;
				break;
			case "Stressed":
				image = R.drawable.stressed;
				break;
			case "Shocked":
				image = R.drawable.shocked;
				break;
			case "Restless":
				image = R.drawable.restless;
				break;
			case "Motivated":
				image = R.drawable.motivated;
				break;
			case "Tension":
				image = R.drawable.tension;
				break;
			case "Relaxed":
				image = R.drawable.relaxed;
				break;
			case "Creative":
				image = R.drawable.creative;
				break;
			case "Energetic":
				image = R.drawable.energetic;
				break;
			case "Lazy":
				image = R.drawable.lazy;
				break;
			case "Confident":
				image = R.drawable.confident;
				break;
		}
		return image;
	}
    ...
    public static ArrayList<String> getUniqueDates(ArrayList<Mood> moodList){
		ArrayList<String> allDates = new ArrayList<>();

		for(Mood mood : moodList){
			Date currentDate = AppUtils.convertToDate(mood.getCurrentTime());
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
			allDates.add(format.format(currentDate));
		}

		Set<String> uniqueDates = new HashSet(allDates);
		System.out.println("Unique gas count: " + uniqueDates.size());

		allDates = new ArrayList<>(uniqueDates);
