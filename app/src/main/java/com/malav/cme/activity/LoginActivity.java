...
public class LoginActivity extends AppCompatActivity {
    ...
    //sharedPreferences
    public static String filename = "MoodAppKey";
                    ...
                    public void onSuccess(LoginResult loginResult) {
                        ...
                        GraphRequest request = GraphRequest.newMeRequest(accessToken, new GraphRequest.GraphJSONObjectCallback() {
                            ...
                            public void onCompleted(JSONObject user, GraphResponse graphResponse) {
                                student.setStudentEmail(user.optString("email"));
                                student.setStudentName(user.optString("name"));
                                ...
                                if (CommonUtils.isNotNull(student.getStudentEmail())) {
                                    new CheckUserInDB(student).execute();
                                }
                            }
                        });
    ...
    private class CheckUserInDB extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                List<NameValuePair> para = new ArrayList<NameValuePair>();
                para.add(new BasicNameValuePair("emailId", student.getStudentEmail()));
                para.add(new BasicNameValuePair("name", student.getStudentName()));
                Log.d("request!", "starting");
            ...
            if (student.getStudentEmail().equalsIgnoreCase("abc@prestige.com")) {
                role = "Admin";
            }
            return false;
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                SharedPreferences.Editor editor = someData.edit();
                editor.putString("emailId", student.getStudentEmail());
                editor.putString("role", role);
                editor.putString("login", "true");
                editor.putString("name", name);
                editor.putString("profilePic", profilePic);
                ...
                if (registered == 1) {
                    if (role.equalsIgnoreCase("U")) {
                        i = new Intent(LoginActivity.this, MoodActivity.class);
                    } else if(role.equalsIgnoreCase("A")){
